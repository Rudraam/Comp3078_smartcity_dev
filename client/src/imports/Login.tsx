import svgPaths from "./svg-cwprtmtcru";

function Login2() {
  return (
    <div className="absolute bg-[#5281e0] h-[225px] left-[2187px] rounded-[8px] top-[2526px] w-[2244px]" data-name="Login">
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip p-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[1.2] not-italic relative shrink-0 text-[#0f1319] text-[72px] tracking-[-2.16px]">Sign In</p>
      </div>
...
function InputField() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[192px] items-start justify-center left-[2188px] top-[1729px] w-[2244px]" data-name="Input Field">
...
function UsernameBar() {
  return (
    <div className="absolute contents left-[2188px] top-[1729px]" data-name="Username Bar">
      <InputField />
      <div className="absolute flex items-center justify-center left-[2227px] size-[125px] top-[1806px]">
...
function InputField1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[192px] items-start justify-center left-[2186px] top-[2134px] w-[2244px]" data-name="Input Field">
...
function PasswordBar() {
  return (
    <div className="absolute contents left-[2186px] top-[2134px]" data-name="Password Bar">
      <InputField1 />
      <div className="absolute flex items-center justify-center left-[2232px] size-[114px] top-[2218px]">
        <div className="-scale-y-100 flex-none rotate-180">
          <Lock />
        </div>
      </div>
...
function Login3() {
  return (
    <div className="absolute h-[200px] left-[2212px] rounded-[8px] top-[1258px] w-[1070px]" data-name="Login" style={{ backgroundImage: "linear-gradient(90deg, rgb(15, 19, 25) 0%, rgb(15, 19, 25) 100%), linear-gradient(90deg, rgb(44, 44, 44) 0%, rgb(44, 44, 44) 100%)" }}>
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip p-[12px] relative rounded-[inherit] size-full">
...
function Register() {
  return (
    <div className="absolute h-[200px] left-[3333px] rounded-[8px] top-[1258px] w-[1070px]" data-name="Register" style={{ backgroundImage: "linear-gradient(90deg, rgb(31, 37, 51) 0%, rgb(31, 37, 51) 100%), linear-gradient(90deg, rgb(15, 19, 25) 0%, rgb(15, 19, 25) 100%), linear-gradient(90deg, rgb(44, 44, 44) 0%, rgb(44, 44, 44) 100%)" }}>
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip p-[12px] relative rounded-[inherit] size-full">
...
function Login1() {
  return (
    <div className="absolute contents left-0 top-0" data-name="Login">
      ...
      <div className="absolute flex h-[2724px] items-center justify-center left-[2003px] top-[224px] w-[2612px]">
        <div className="-scale-y-100 flex-none rotate-180">
