    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6">
        ...
        <div>
          ...
          <p className={`mb-1 font-medium ${
            weather.airQuality > 200 ? "text-red-500" :
            weather.airQuality > 150 ? "text-red-400" :
            weather.airQuality > 100 ? "text-orange-400" :
            weather.airQuality > 50 ? "text-yellow-400" :
            "text-green-400"
          }`}>{weather.airQualityLabel}</p>
          <p className={`text-sm ${
            weather.airQuality > 150 ? "text-red-300" :
            weather.airQuality > 100 ? "text-orange-300" :
            weather.airQuality > 50 ? "text-yellow-300" :
            "text-[#51a2ff]"
          }`}>
      ...
      <div className="mt-4">
        <div className="flex items-center justify-between mb-2">
          <p className="text-[#99a1af] text-xs">PM2.5</p>
          <p className="text-[#99a1af] text-xs">{weather.pm25 ?? 0} ug/m3</p>
        </div>
