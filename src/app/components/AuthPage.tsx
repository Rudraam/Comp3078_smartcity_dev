    ...
    <div>
      ...
      <div className="flex items-center gap-3 bg-[#0f1319] border border-[#d9d9d9] rounded-lg px-4 py-3 md:py-4 focus-within:border-[#5281e0] transition-colors">
        ...
        <input
          ...
          className="flex-1 bg-transparent text-[#98aab3] text-lg md:text-xl focus:outline-none"
        />
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-[#0f1319] flex items-center justify-center px-4 py-8 font-['Inter',sans-serif]">
      ...
      >
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-[#5281e0] hover:bg-[#4170cf] transition-colors text-[#0f1319] py-4 md:py-5 rounded-lg text-2xl md:text-3xl font-bold mt-8"
          >
